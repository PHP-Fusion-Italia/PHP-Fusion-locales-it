...
Sono passati ben ".$settings['deactivation_period']." giorni dall'ultima volta che ti abbiamo visto su ".$settings['sitename'].". Il tuo account è stato marcato come inattivo ma tutti i tuoi dati rimangono preservati.\n
...
Il tuo account su ".$settings['sitename']." è stato bannato da ".$userdata['user_name']." con la seguente motivazione:\n
[REASON].\n
...
Il tuo account su ".$settings['sitename']." è stato bannato da ".$userdata['user_name']." a causa di attività malevole riscontrate sul tuo account (virus o altro).\n
Se vuoi avere maggiori informazioni, sei pregato di contattare via email l'amministratore scrivendo a ".$settings['siteemail'].".\n
".$settings['siteusername'];

$locale['email_suspend_subject'] = "Notifica account sospeso su ".$settings['sitename'];
$locale['email_suspend_message'] = "Ciao [USER_NAME],\n
Il tuo account su ".$settings['sitename']." è stato sospeso da ".$userdata['user_name']." fino al [DATE] con la seguente motivazione:\n
[REASON].\n
Se vuoi avere maggiori informazioni, sei pregato di contattare via email l'amministratore scrivendo a ".$settings['siteemail'].".\n
".$settings['siteusername'];
?>
